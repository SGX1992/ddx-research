 ...
 *   ALLOWED_ORIGINS     optional — comma-separated; defaults to the DDX hosts
 *
...
const SURVEY_DB = process.env.NOTION_SURVEY_DB || 'c55811e5-d7f3-4194-8fd8-c748d755d7f2';
const CONTACT_DB = process.env.NOTION_CONTACT_DB || '806fb480-febf-4ff9-9f5c-dfee90f46aed';

const DEFAULT_ORIGINS = [
  'https://research.ddxconference.com',
  'https://www.ddxconference.com',
  'http://localhost:8793',
  'http://127.0.0.1:8793',
];
